        ...
        case "msg":
            switch (msg.data.action) {
                ...
                case 'refreshHighlighting':
                    console.log('Refresh Highlighting:', JSON.stringify(msg.data, null, 2));
                    // der Message das gelöschte oder gemergte objekt hinzufügen!
                    onAttach();
                    break;
                default:
                    console.log('Received unknown message from iframe', JSON.stringify(msg.data, null, 2));
                    break;
            }
    }
});
...
chrome.contextMenus.onClicked.addListener((info, tab) => {
    ...
    console.log("onclicked data:" + JSON.stringify(info, null, 2))
