            ...
            async.series([function (next) {
                ...
                */
                ...
                chrome.tabs.captureVisibleTab(function (screenshotUrl) {
                    saveRemote(items.server.replace(/\/$/, '') + '/Sites/' + siteId + '/image', { image: screenshotUrl }, function (err) {
                        next(err);
                    });
                });
            }, function (next) {
                ...
                captureTab(article.bounds, function (image) {
                    saveRemote(items.server.replace(/\/$/, '') + '/Articles/' + articleId + '/image', { image: image }, function (err) {
                        next(err);
                    });
                });
            }], function (err) {
